    ...
    <main>
      ...
      <section className="ServicesContainer">
        ...
        <div className="ListContainer">
          <ServiceCard imageSrc="/724eventsProjetOpenClassRooms/images/priscilla-du-preez-Q7wGvnbuwj0-unsplash1.png">
          ...
          <ServiceCard imageSrc="/724eventsProjetOpenClassRooms/images/hall-expo.png">
            <h3>Conférences</h3>
          ...
          <ServiceCard imageSrc="/724eventsProjetOpenClassRooms/images/sophia-sideri-LFXMtUuAKK8-unsplash1.png">
      ...
      <section className="PeoplesContainer" id="#notre-equipe">
        ...
        <div className="ListContainer">
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/stephanie-liverani-Zz5LQe-VSMY-unsplash.png"
            name="Samira"
            position="CEO"
          />
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/linkedin-sales-solutions-pAtA8xe_iVM-unsplash.png"
            name="Jean-baptiste"
            position="Directeur marketing"
          />
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/christina-wocintechchat-com-SJvDxw0azqw-unsplash.png"
            name="Alice"
            position="CXO"
          />
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/jonas-kakaroto-KIPqvvTOC1s-unsplash.png"
            name="Luís"
            position="Animateur"
          />
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/amy-hirschi-b3AYk8HKCl0-unsplash1.png"
            name="Christine"
            position="VP animation"
          />
          <PeopleCard
            imageSrc="/724eventsProjetOpenClassRooms/images/christina-wocintechchat-com-0Zx1bDv5BNY-unsplash.png"
            name="Isabelle"
